  ...
  <form action="StudentServlet" method="post" onsubmit="return validateForm()">
    ...
    <div class="row">
      <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control" id="firstname" name="firstname"
               value="${stdData.firstName}" required>
      </div>
      <div class="col-md-6 mb-3">
        <label for="lastname" class="form-label">Last Name</label>
        <input type="text" class="form-control" id="lastname" name="lastname"
               value="${stdData.lastName}" required>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control" id="fathername" name="fathername"
               value="${stdData.fatherName}" required>
      </div>
      <div class="col-md-6 mb-3">
        <label for="surname" class="form-label">Surname</label>
        <input type="text" class="form-control" id="surname" name="surname"
               value="${stdData.surname}" required>
      </div>
    </div>

    <div class="mb-3">
      <label class="form-label">Select Gender</label><br>
      <c:forEach var="gender" items="${studallgenders}">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="gender" value="${gender}"
                 <c:if test="${gender == studselectedGender}">checked</c:if>>
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="cnic" name="cnic"
             value="${stdData.cnic}" required>
    </div>

    <div class="mb-3">
      <label for="contactNo" class="form-label">Contact Number</label>
      <input type="text" class="form-control" id="contactNo" name="contactNo"
             value="${stdData.contactNo}" required>
    </div>

    <div class="mb-3">
      <label for="email" class="form-label">Email ID</label>
      <input type="email" class="form-control" id="email" name="email"
             value="${stdData.emailId}" required>
    </div>

    <div class="mb-3">
      <label for="address" class="form-label">Current Address</label>
      <textarea class="form-control" id="address" name="address" rows="3" required>${stdData.address}</textarea>
    </div>
